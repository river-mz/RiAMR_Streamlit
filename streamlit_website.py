...
# 准备 GIF 文件路径
gif_path = "./resource/animated_icon.gif"
...
model_dir = '/ibex/project/c2205/AMR_dataset_peijun/model_prediction/model_Ours_Oct_5'
...
if selected == "Home":
    ...
    with stylable_container(
        ...
        if input_method == "Upload CSV":
            ...
            to_correct_type = ['race', 'veteran', 'previous_antibiotic_exposure_cephalosporin','previous_antibiotic_exposure_carbapenem','previous_antibiotic_exposure_fluoroquinolone',
